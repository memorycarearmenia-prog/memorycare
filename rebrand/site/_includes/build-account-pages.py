...
def p_index(loc):
    L = ['<section class="mc-section">', '  <div class="mc-page">',
         ...
         '      <li class="mc-num"><a href="' + a(loc, 'common.tel') + '">' + t(loc, 'common.phone') + '</a></li>',
         '      <li>' + t(loc, 'common.founder.davit.name') + ' — ' + t(loc, 'common.founder.davit.role') + '</li>',
         '      <li>' + t(loc, 'common.founder.hayk.name') + ' — ' + t(loc, 'common.founder.hayk.role') + '</li>',
...
def p_plots(loc):
    ...
    L = ['<section class="mc-section">', '  <div class="mc-page">',
         ...
         '        <a class="mc-btn mc-btn--primary" href="/%s/account/plot-new.html">%s</a>' % (loc, t(loc, 'account.plots.add.cta')),
         '        <a class="mc-btn mc-btn--secondary" href="' + a(loc, 'common.tel') + '">' + t(loc, 'common.phone') + '</a>',
         '      </div>',
         '    </div>',
         '',
...
def p_plot_new(loc):
    L = ['<section class="mc-section">', '  <div class="mc-page mc-page--narrow mc-stack--loose mc-stack">',
         ...
         '    <p class="mc-num"><a href="' + a(loc, 'common.tel') + '">' + t(loc, 'common.phone') + '</a> · <a href="mailto:' + a(loc, 'common.email') + '">' + t(loc, 'common.email') + '</a></p>',
         '  </div>',
         '</section>']
    return '\n'.join(L)
